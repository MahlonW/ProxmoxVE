...
service:
  ...
  MahlonW/ProxmoxVE:
    latest_version:
      type: github
      url: MahlonW/ProxmoxVE
      use_prerelease: false
    dashboard:
      icon: https://raw.githubusercontent.com/MahlonW/ProxmoxVE/refs/heads/main/misc/images/logo.png
      icon_link_to: https://helper-scripts.com/
      web_url: https://github.com/MahlonW/ProxmoxVE/releases
EOF
msg_ok "Setup Config"
